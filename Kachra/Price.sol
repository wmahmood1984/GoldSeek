...
address public owner;
    ...
    uint256 rate;
     ...
     payable(owner).transfer(remainder);
        ...
        uint256 tokenToBuy = ValueForToken / rate;
        (
          uint256 tTransfer, 
         uint256 tfee, 
         uint256 dist,
    ...
    function sell(uint256 NoOfTokens) public payable {
        ...
        uint256 rate = Rate_();
        uint256 coreTronValues = rate * NoOfTokens;
        ...
        uint256 tokenToSell = ValueForToken / rate;
...
function Rate_()
    ...
    {    
        return ethereumToTokens_(100000000000) / 100000000000;
